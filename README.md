...
- **漢語大字典** — 無料で読めるページ画像が見つからない。スキャンを持っている 国学大师 は、
  Cloudflare WARP の内側からも、WARP の外に出た回線からも接続できなかった
  (同じ回線から example.com は開けるので、サイト側が日本から届かないということになる)。
- **大漢和辞典・宋本広韻・大字源** — 無料のオンライン版が無い。番号のみ載せている。
- 論文「Biáng 形纹样探究」、《潮语十五音》、韓国歴史情報統合システム — 到達できなかった。
